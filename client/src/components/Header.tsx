    ...
    <header className=" text-white z-40 bg-black body-font fixed h-18 w-screen">
      ...
      <div className="hidden md:block container mx-auto md:flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <div className="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
          ...
          >
            <span className="w-48 h-48 rounded rotate-[-40deg] bg-red-600 absolute bottom-0 left-0 -translate-x-full ease-out duration-500 transition-all translate-y-full mb-9 ml-9 group-hover:ml-0 group-hover:mb-32 group-hover:translate-x-0" />
